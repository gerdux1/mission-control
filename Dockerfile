...
# Cockpit Phase-2 action panels register client-side, so their flags must be
# inlined into the browser bundle at build time too (default OFF / empty).
ARG NEXT_PUBLIC_COCKPIT_APPROVALS_ENABLED=
ARG NEXT_PUBLIC_COCKPIT_CHAT_ENABLED=
ENV NEXT_PUBLIC_COCKPIT_APPROVALS_ENABLED=${NEXT_PUBLIC_COCKPIT_APPROVALS_ENABLED}
ENV NEXT_PUBLIC_COCKPIT_CHAT_ENABLED=${NEXT_PUBLIC_COCKPIT_CHAT_ENABLED}
# ────────────────────────────────────────────────────────────────────────────
